...
class materiale{
	...
	function Getid_stock()	{return $this->_id_stock;}
	...
	function Setid_stock($id_stock) {$this->_id_stock= $id_stock;}
	...
	public function Add($id_material,$id_stock,$nombre_material,$estado_material,$unidad_medida)
	{
		if(isset($id_material) && $id_material != "")
		{
			$sql="$id_material, $id_stock , '$nombre_material' , '$estado_material' , '$unidad_medida'";
	...
	public function Update($id_material,$id_stock,$nombre_material,$estado_material,$unidad_medida){
		$sql=array("ID_MATERIAL"=>"$id_material","ID_STOCK"=>"$id_stock","NOMBRE_MATERIAL"=>"'$nombre_material'","ESTADO_MATERIAL"=>"'$estado_material'","UNIDADMEDIDA_MATERIAL"=>"'$unidad_medida'");
