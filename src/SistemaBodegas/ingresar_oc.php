...
function verifica()
{
   ...
   {
		alert("Debe ingresar un Numero de Orden de Compra");
...
function verifica2()
{
	if(document.miform.fecha_tope.value.length==0){
		alert("Debe seleccionar la fecha del documento");
      	return 0;
	}else{
	document.miform.submitO.value="Ingresar";
	document.miform.submit();
	}
}
</script>
<body>
<form name="miform" action="IngresarProveedorBD.php" method="post"><input
	type="hidden" name="submitO" value="oc" />
...
<td width="37"><input type="button" name="submit1" value="oc" onclick="<?php echo $boton; ?>"/></td>
...
<tr><td colspan="7" align="center"><input type="button" name="submit1" value="Guardar" onclick="<?php echo $boton2; ?>"/></td></tr>
<tr></tr>
</table>
</form>
</body>
