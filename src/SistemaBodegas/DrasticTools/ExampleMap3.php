...
<table><tr>
<td><div id="map1" style="width: 350px; height: 350px;"/></td>
<td><div id="map2" style="width: 350px; height: 350px;"/></td>
</tr></table>
<script type="text/javascript">
var thegrid1 = new drasticMap('map1', {pathimg:"img/", displaycol: "Population", icon: "circle"});
var thegrid2 = new drasticMap('map2', {pathimg:"img/", displaycol: "SurfaceArea", icon: "bar"});
</script>
